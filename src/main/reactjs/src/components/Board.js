                ...
                <table style={{borderCollapse: 'collapse', border: '1px solid black'}}>
                    <tr>
                        ...
                        <td style={{textAlign: 'left'}}>
                            <input type="text" name="boardTitle" id="boardTitle" value={board ? board.boardTitle : ''}
                    ...
                    <tr>
                        ...
                        <td style={{textAlign: 'left'}}>
                            <input type="text" name="boardWriter" id="boardWriter" readonly
                                   value={board ? board.boardWriter : ''}></input>
                        </td>
                    </tr>
                    <tr>
                        <td style={{background: 'skyblue'}}>
                        ...
                        <td style={{textAlign: 'left'}}>
                            <div id="image_preview">
                                ...
                                <div id="attZone">
                                    {boardFileList
                                        ?
                                        <FileList boardFileList={boardFileList} addChangeFile={addChangeFile}
                                                  changeOriginFile={changeOriginFile}></FileList>
                                        :
                                        null}
                                </div>
                            </div>
